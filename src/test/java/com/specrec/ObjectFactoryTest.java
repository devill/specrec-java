...
class ObjectFactorySetAlwaysTest {
    private ObjectFactory factory;
...
class ObjectFactoryConstructorTest {
    private ObjectFactory factory;
...
class ObjectFactoryInheritanceTest {
    private ObjectFactory factory;
...
class TestImplementationWithConstructor implements ITestInterface {
    private final String name;
    private final int value;
...
class MockTestImplementation implements ITestInterface, IConstructorCalledWith {
...
class MockChildClass extends ParentClass implements IConstructorCalledWith {
    private Object[] lastConstructorArgs;
    private ConstructorParameterInfo[] lastParameterDetails;
...
class MockTestClassWithConstructor extends TestClassWithConstructor implements IConstructorCalledWith {
    private Object[] lastConstructorArgs;
    private ConstructorParameterInfo[] lastParameterDetails;
